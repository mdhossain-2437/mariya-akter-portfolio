    ...
    <div className="pt-16 md:pt-20">
      <section className="container-narrow pt-12 md:pt-20 pb-16">
        <div className="grid md:grid-cols-12 gap-10 items-end">
          <div className="md:col-span-8 fade-up">
            <h1 className="font-serif text-ink-900 leading-[1] text-[clamp(3rem,9vw,7rem)]">
      ...
      <section className="container-narrow pb-24 grid md:grid-cols-12 gap-10">
        <aside className="md:col-span-5">
          <div className="bg-cream-200 rounded-sm p-8 md:p-10">
            <p className="label-muted">Direct Communication</p>
            <p className="mt-3 font-serif italic text-2xl text-ink-900">
            ...
            <div className="mt-10">
              ...
              <ul className="mt-3 space-y-2 font-serif italic text-lg text-ink-800">
        ...
        <div className="md:col-span-7">
          <h2 className="font-serif italic text-2xl md:text-3xl text-ink-900">
      ...
      <section className="container-narrow pb-24 md:pb-32">
        ...
        <ul className="mt-8 divide-y divide-ink-200">
          {HIGHLIGHTS.map((h) => (
            <li key={h.title} className="flex items-center justify-between py-6 md:py-8">
              <span className="font-serif italic text-2xl md:text-3xl text-ink-900">{h.title}</span>
